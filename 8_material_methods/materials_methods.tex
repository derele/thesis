...
\subsection{RNA exrtaction and preparation of sequencing libraries}
...
scaled counts, similar to teh weighted trimmed mean of the log
...
informed (and biased by the) design. These data were used in all
