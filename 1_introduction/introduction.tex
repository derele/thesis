...
for the use of paratenic host in Asia is rather likely to be a a
result of the lack of appropriate studies in Asian water systems,
given the broad spectrum of paratenic hosts use by \textit{A. crassus}
in Europe
...
of phenotypic differences from environmental (E) influences. Tey have
...
and and the Taiwanese population of worms were examined. These
...
These findings show tha an increase in the speed of development was
...
base-pairing with itself or other (macro-)molecules. It is involved in
...
transcriptme provides information about genomic features), but they
...
\figuremacro{sequencing_costs}{Falling sequencing costs}{First (till
  ...
  Sanger-sequencing and the invention of pyro-sequencing. Later (since
...
Other aspects of the central questions regading the evolution of
