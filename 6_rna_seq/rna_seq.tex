...
\caption[Summary of RNA preparation]{\textbf{A summary of all 24
  ...
  European, T for Taiwanese; letter after the slash in the label, note
  however, that the European samples were from two locations: River
  Rhein, R and Berlin, B in population column) and sex of worm(s) in
  preparation (F for female, M for male; last letter in
...
euclidian distances (see figure \ref{heat_all} a).
...
\section{Orthologous screeing for expression differences}
...
For the lower number of contigs DE between host-species obviousely
...
other enzymes from lipid metabolism.


\section{Clustering analysis}

Clustering alalysis revealed...
...
superposed interaction effects.
...
population. Counts summed for orhologs were also significant only for
