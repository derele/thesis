...
\figuremacro{tGO_DN_DS_BP_classic_10_all}{GO biological process graph
  ...
  indicate the 10 most significant terms. Box color represents the
  relative significance, ranging from dark red (most significant) to
  light yellow (least significant). In each node the
  categoy-identifier, a (eventually truncated) description of the
...
\figuremacro{tGO_DN_DS_CC_classic_10_all}{GO cellular compartment
  ...
  terms. Box color represents the relative significance, ranging from
  dark red (most significant) to light yellow (least significant). In
  each node the categoy-identifier, a (eventually truncated)
...
\figuremacro{tGO_EEL_EXP_BP_classic_10_all}{GO biological process
  ...
  significant terms. Box color represents the relative significance,
  ranging from dark red (most significant) to light yellow (least
  significant). In each node the categoy-identifier, a (eventually
...
\figuremacro{sex_all_heat}{Clustering of expression values for contigs
  ...
  stabilized expression values. Deprograms are based on euclidean
...
\figuremacro{eel_all_heat}{Clustering of expression values for contigs
  ...
  \textit{An. anguilla}}{A heatmap of variance/mean stabilized
...
\figuremacro{eel_ortho_heat}{Clustering of expression values for contigs
  DE between worms in \textit{An. japonica} and
  \textit{An. anguilla}}{A heatmap of variance/mean stabilized
  expression values. Deprograms are based on euclidean distance and
  hierarchically clustering. Green indicates expression below the
