...
\figuremacro{sex_all_heat}{Heatmap for contigs DE between male and
  female worms}{Differentially expressed contigs between male and
  female worms}

\figuremacro{sex_ortho_heat}{Heatmap for OC contigs DE between male
  and female worms}{Differentially expressed contigs between male and
  female worms}

\figuremacro{eel_all_heat}{Heatmap for contigs DE between worms in
  \textit{An. japonica} and \textit{An. anguilla}}{foo}

\figuremacro{eel_ortho_heat}{Heatmap for contigs DE between worms in
  \textit{An. japonica} and \textit{An. anguilla}}{foo}
