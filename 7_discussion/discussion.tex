...
I was able to obtain high-quality annotations for a large set of TUGs:
...
The percentage of recovered European worms is in agreement with data
...
\figuremacro{pop_ortho_heat}{Clustering of expression values for OC
  ...
  of samples (columns) below the plot. Expression levels for libraries
  are clustering mainly according to the sex of worms. However, in
  both male and female worms subordinate clusters are following a
  worm-population and to a lesser extend (and mainly in males) a
  host-species pattern. Below contig-names uniprot names are given for
  ortholog genes in \textit{B. malayi}. Genes are clustering according
  to annotation-profiles: the top cluster represents genes important
  in energy metabolism. They cluster with COXII, which shows clear
...
The presented project on divergence of gene expression obviously
